...
//                Date birthDay = birthDayFormat.parse(attributes.getValue("birthDay"));
                voter = new Voter(attributes.getValue("name"), birthDayFormat.parse(attributes.getValue("birthDay")).getTime());
            }
            else if (qName.equals("visit") && voter != null){
//                int count = voterCount.getOrDefault(voter, 0);
                voterCount.put(voter, voterCount.getOrDefault(voter, 0) + 1);
            }
        }
